...
export const translations: Record<Language, Translations> = {
  english: {
    ...
    profileDescription: "Senior Full Stack Developer with extensive experience in building scalable web applications, AI-driven automation solutions, and intelligent bots. Proven expertise across front-end and back-end technologies, system architecture, and workflow automation.\n\nAdept at leading cross-functional teams, managing complex projects end-to-end, and delivering high-impact solutions that align with business goals. Strong problem-solver with a focus on innovation, efficiency, and quality delivery.",
    ...
    footerCopyright: '© 2025 Mohammad Asadi. All rights reserved.',
  ...
  sarcasm: {
    ...
    footerCopyright: '© 2025 Mohammad Asadi. All rights reserved (not that anyone cares).',
  ...
  lorem: {
    ...
    footerCopyright: '© MMXXV Mohammad Asadi. Omnia iura reservata.',
  ...
  youngStunnah: {
    ...
    footerCopyright: '© 2025 Mohammad Asadi. Respeto lang sa copyright ha.',
